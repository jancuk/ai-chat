...
function initializeChatInterface() {
  ...
  container.innerHTML = `
    <div id="chat-window" class="fixed bottom-0 right-0 w-full sm:w-96 bg-white shadow-lg rounded-t-lg transition-all duration-300 ease-in-out">
  ...
  function toggleMaximize() {
    ...
    if (isMaximized) {
      ...
      chatContent.classList.add("h-[calc(100vh-140px)]");
      ...
      chatContent.classList.remove("h-[calc(100vh-140px)]");
      maximizeBtn.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" />
        </svg>
